...
void draw_window(sf::RenderTarget& window)
{
    ...
    sf::Text text_1;
    text_1.setFont(font);
    text_1.setString("Player 1");// set the string to display
    ...
    sf::Text text_2;
    text_2.setFont(font);
    text_2.setString("Player 2");// set the string to display
    ...
    sf::Text text_3;
    text_3.setFont(font);
    text_3.setString("Player 3");// set the string to display
    ...
    text_3.setPosition(1075, 870);

    // Player 4
    sf::Text text_4;
    text_4.setFont(font);
    text_4.setString("Player 4");// set the string to display
    ...
    window.draw(score1); // output score board 1
    window.draw(text_s1); // output score 1 tile
    window.draw(score2); // output score board 2
    window.draw(text_s2); // output score 2 tile
    window.draw(score3); // output score board 3
    window.draw(text_s3); // output score 3 tile
    window.draw(score4); // output score board 4
    window.draw(text_s4); // output score 4 tile
    window.draw(text_1); // output Player 1
    window.draw(text_2); // output Player 2
    window.draw(text_3); // output Player 3
    window.draw(text_4); // output Player 4
